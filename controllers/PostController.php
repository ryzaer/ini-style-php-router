...
class PostController
{
    ...
    {   
        ...
        $pdo->blob('png')->update('tbblob', ['filedata'=>'./doraemon.gif'],['id'=>'1']);
        ...
        try {
            // Ubah path jika mime.types kamu disimpan di lokasi lain
            $mimeParser = new \mimeTypes();

            $mimeType = 'image/jpeg';
            $ext = $mimeParser->getExtension($mimeType);
